...
describe('AutoTrackerTokenBuilder', () => {
  ...
  describe('Constructor', () => {
    describe('basic initialization without chain ID', () => {
  ...
  describe('setChainId()', () => {
    describe('sets chain ID successfully', () => {
    ...
    describe('can update existing chain ID', () => {
  ...
  describe('initialiseRawData()', () => {
    describe('throws when chain ID not set', () => {
    ...
    describe('creates new RawTokenDataCache with chain ID', () => {
    ...
    describe('without rawDataInput and rawData is not set', () => {
    ...
    describe('throws when chain ID is not set', () => {
      it('should throw error when chain ID is not set', async () => {
        const builder = new AutoTrackerTokenBuilder(tokenAddress);
        expect((builder as any).chainId).toBeUndefined();
        await expect(builder.initialiseRawData()).rejects.toThrow('Chain id is not set');
    ...
    describe('it updates the rawData if it is already set', () => {
  ...
  describe('getRawData()', () => {
    ...
    describe('creates new instance if rawData is null', () => {
    ...
    describe('returns existing rawData', () => {
    ...
    describe('throws when rawData is not set', () => {
  ...
  describe('getInitialData()', () => {
    describe('Chain ID Resolution', () => {
      describe('without chain ID resolves it automatically', () => {
      ...
      describe('throws if no chain ID returned from API', () => {
      ...
      describe('with chain ID uses specific endpoint', () => {
      ...
      describe('initializes rawData with response', () => {
  ...
  describe('collect()', () => {
    describe('calls initialiseRawData() if raw data is not set', () => {
    ...
    describe('fetches all data sources in parallel', () => {
    ...
    describe('returns collected data structure', () => {
      it('should return object with all collected data', () => {
        // TODO: Implement
      });
    });

    describe('handles partial data from sources', () => {
    ...
    describe('handles source failures gracefully', () => {
  ...
  describe('getGmgnAutoTrackerToken()', () => {
    ...
    describe('returns null when gmgn data missing', () => {
      it('should return null if GMGN token info is missing', () => {
        // TODO: Implement
      });
    });

    describe('returns null when gmgn socials missing', () => {
      it('should return null if GMGN socials are missing', () => {
        // TODO: Implement
      });
    });

    describe('returns null when both gmgn sources missing', () => {
      it('should return null if both GMGN data sources are missing', () => {
        // TODO: Implement
      });
    });

    describe('returns mapped token when data available', () => {
  ...
  describe('getBirdeyeAutoTrackerToken()', () => {
    ...
    describe('returns null when token overview missing', () => {
      it('should return null if Birdeye token overview is missing', () => {
        // TODO: Implement
      });
    });

    describe('returns null when security data missing', () => {
      it('should return null if Birdeye security data is missing', () => {
        // TODO: Implement
      });
    });

    describe('returns null when markets missing', () => {
      it('should return null if Birdeye markets data is missing', () => {
        // TODO: Implement
      });
    });

    describe('returns null when markets array empty', () => {
    ...
    describe('uses first market for pair address', () => {
  ...
  describe('getToken()', () => {
    describe('resolves chain ID before fetching', () => {
      it('should call getInitialData to resolve chain ID if not set', () => {
        // TODO: Implement
      });
    });

    describe('throws when both sources fail to return data', () => {
      it('should throw error when both GMGN and Birdeye return null', () => {
        // TODO: Implement
      });
    });

    describe('returns merged token when both sources succeed', () => {
      it('should merge tokens from both sources using AutoTrackerToken.mergeMany', () => {
        // TODO: Implement
      });
    });

    describe('returns token when only GMGN succeeds', () => {
      it('should return token when only GMGN has data', () => {
        // TODO: Implement
      });
    });

    describe('returns token when only Birdeye succeeds', () => {
      it('should return token when only Birdeye has data', () => {
        // TODO: Implement
      });
    });

    describe('filters null tokens before merging', () => {
  ...
  describe('getDbToken()', () => {
    describe('returns null when token not in database', () => {
    ...
    describe('calls toModel to convert DB token', () => {
    ...
    describe('queries by token address', () => {
  ...
  describe('getOrCreate()', () => {
    describe('Database Scenarios', () => {
      ...
      describe('returns existing token with complete data', () => {
      ...
      describe('does not fetch from APIs when token complete', () => {
      ...
      describe('fetches when token not in database', () => {
      ...
      describe('fetches when token missing required fields', () => {
    ...
    describe('Parallel Fetching', () => {
      describe('fetches from both sources in parallel', () => {
        it('should fetch GMGN and Birdeye tokens concurrently after collect', () => {
          // TODO: Implement
        });
      });

      describe('collect is called before individual fetches', () => {
  ...
  describe('Integration Tests - Complete Flows', () => {
    describe('complete flow from scratch without chain ID', () => {
    ...
    describe('complete flow with chain ID provided', () => {
      it('should handle complete flow when chain ID is known', () => {
        // TODO: Implement
      });
    });

    describe('partial DB data enriched by APIs', () => {
  ...
  describe('Error Handling', () => {
    ...
    describe('getInitialData API failure', () => {
      it('should handle getInitialData API failures', () => {
        // TODO: Implement
      });
    });

    describe('collect failure', () => {
    ...
    describe('validation failure with detailed message', () => {
  ...
  describe('Chain ID Behavior', () => {
    describe('correct chain used throughout flow', () => {
      it('should maintain consistent chain ID across all API calls', () => {
        // TODO: Implement
      });
    });

    describe('resolution updates builder state', () => {
      it('should update builder\'s chain ID after resolution', () => {
        // TODO: Implement
      });
    });

    describe('used in RawTokenDataCache initialization', () => {
